...
- **Starting tile orientation.** Every civilization's starting tile was laid
  ...
  corner (M5–P8) instead of the top-right. Branch
  `fix/starting-tile-orientation`; the human waived the review gate and verified
  in the browser instead. 1 new engine test (429 total).
