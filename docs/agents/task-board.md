...
- **Notes:** Follow-up requested by the human: use the supplied WaW government
  card images alongside the accessible text instead of the synthetic card box.
