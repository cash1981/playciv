...
/** Height of the map itself, not counting the player areas. */
...
export const areaBandTop = (board: Board): number =>
  mapHeight(board) + AREA_GAP_SQUARES * board.squareSize

/** Full height of the drag surface: map, gap and player areas. */
...
/** Where a piece is, in words: a map square or a player's area. */
