...
describe('BattlePanel mobile placement', () => {
  ...
  it('drags a selected arena unit to another front with touch pointers', () => {
    ...
    fireEvent.pointerDown(card, { pointerId: 7, pointerType: 'touch', clientX: 10, clientY: 10 })
    fireEvent.pointerMove(card, { pointerId: 7, pointerType: 'touch', clientX: 30, clientY: 10 })
    fireEvent.pointerUp(card, { pointerId: 7, pointerType: 'touch', clientX: 30, clientY: 10 })
